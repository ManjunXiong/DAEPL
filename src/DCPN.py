...
class DCPN(object):
    def __init__(self,
        ...
        self.learning_rate = tf.Variable(0.00001, trainable=False, name='learning_rate')
    ...
    def cluster(self, x, reduce = True):
        ...
        # y = y.astype(int)
        # scio.savemat('CWRU5005.mat',
        #              {"z": z_reduced, "y_true": y,"y_pre":z_label})
        return z_label
    ...
    def evaluate(self,flag_all = False):
        ...
        return acc,nmi,ari
        # import scipy.io as scio
        # scio.savemat('y_y_true.mat', {"y": y, "y_true": y})
    ...
    def visulization(self,name = 'temp.png',save_dir = None,flag=0):
        ...
        # import scipy.io as scio
        y = y.astype(int)
        # scio.savemat( 'z_y_true.mat',
        #              {"z": z_reduced,  "y_true": y})
        ...
        plt.xlabel('First dimension', fontsize=12, color='black')
        plt.ylabel('Second dimension', fontsize=12, color='black', fontproperties='SimHei')
